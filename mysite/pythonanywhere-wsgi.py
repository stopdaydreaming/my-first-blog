...
# web application at http://stopdaydreaming.pythonanywhere.com/
...
#import sys
#
#path = '/home/stopdaydreaming/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/stopdaydreaming/mysite/mysite/settings.py'
## and your manage.py is is at '/home/stopdaydreaming/mysite/manage.py'
#path = '/home/stopdaydreaming/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
#path = '/home/stopdaydreaming/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
